            ...
            <div className="max-w-md w-full mx-6 relative">
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-indigo-100 border border-white p-10 md:p-12">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-500 font-medium">Log in to access your health records</p>
                    </div>
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-slate-500 font-medium">
                            Don't have an account? <Link to="/register" className="text-indigo-600 font-bold hover:text-indigo-700 transition-colors">Register for free</Link>
                        </p>
                    </div>
                </div>
            </div>
